			...
			<div className="mt-5 rounded-2xl overflow-hidden shadow-md">
				<figure class="sm:flex bg-white rounded-xl p-5 sm:p-0">
					...
					<div className='flex items-center'>
				  		<Image class="w-32 h-32 sm:w-48 sm:h-auto sm:rounded-none object-cover rounded-lg block sm:hidden" src={podcast.thumbnail} alt="" width="0" height="0" />
				  ...
				  <div class="sm:pt-6 pt-1 sm:p-5 text-center sm:text-left space-y-4">
				    <blockquote>
						<h1 className='sm:text-2xl lg:text-3xl hidden sm:block'>{podcast.title}</h1>
