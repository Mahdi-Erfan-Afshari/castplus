	...
	<div className="container mx-auto p-6">
		<div className='relative z-10 xl:mt-0 lg:mt-4 md:mt-12 mt-6'>
			...
			<div className='sm:flex hidden justify-center'>
				<Link href='/podcasts'><button className="mt-8 flex justify-center items-center bg-Blue text-white border-2 border-Blue rounded-lg font-semibold shadow-lg shadow-LightBlue py-3 px-5 home-btn select-none duration-150">
		...
		<div className='flex sm:hidden justify-center'>
			<Link href='/podcasts' className="w-full"><button className="mt-12 w-full flex justify-center items-center bg-Blue text-white border-2 border-Blue rounded-xl font-semibold shadow-lg shadow-LightBlue py-3 px-5 home-btn select-none duration-150">
				<p className='pe-2 text-lg'>Get Started </p>
				<span><BsArrowRight className="text-2xl"/></span>
			</button></Link>
		</div>
